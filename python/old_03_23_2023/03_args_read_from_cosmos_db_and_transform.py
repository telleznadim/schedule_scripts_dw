...
def query_items_by_bu_by_columns(container, company_short, endpoint, date_time_string, columns_list):
    ...
    df.to_csv(f'C:/Users/eviadmin/Documents/Datawarehouse/python_scripts/DataLake/prod/files/from_datalake/{company_short}_{endpoint}_{date_time_string}.csv.gz',
